...
--------
To clone the Prides_Web_Theme repository, use git clone:

<pre>
 git clone https://github.com/wavemaker/Prides_Web_Theme.git
 cd Prides_Web_Theme
 npm install
</pre>
...
Build
--------
To build the WaveMaker Theme run the below command from Prides_Web_Theme directory
